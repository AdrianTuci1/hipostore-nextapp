...
const ThankYouPage = async ({searchParams}: PageProps) => {
    ...
    return (
        <main className="relative lg:min-h-full">
            <div className="hidden lg:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 x1:pr-12">
                <Image 
                fill
            ...
            <div>
                <div className="mx-auto max-w-2x1 px-4 py-16 sm:px-6 sm:py-2 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
                    <div className="lg:col-start-2">
                        <p className="text-sm font-medium text-blue-600">
                            Order succesful
                        </p>
                        <h1 className="mt-2 text-4x1 font-bold tracking-tight text-gray-900 sm:text-5x1">
                            Thanks for ordering
                        </h1>
