...
const Page = () => {
    ...
    return <div className="bg-white">
        <div className="mx-auto max-w-2x1 px-4 pb-24 pt-16 sm:px-6 lg:max-w-7x1 lg:px-8">
            <h1 className="text 3x1 font.bold tracking-tight text-gray-900 sm:text-4x1">
                Shopping Cart
            </h1>

            <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 x1:gap-x-16">
                ...
                {isMounted && items.length === 0 ? (
                    <div className="flex h-full flex-col items-center justify-center space-y-1">
                        <div aria-hidden="true" className="relative mb-4 h-40 w-40 text-muted-foreground">
                            <Image 
                            src="/hiip-empty-cart.png"
                            fill
                            loading="eager"
                            alt="empty shopping cart hippo"
                            />
                        </div>
                        <h3 className="font-semibold text-2x1">Your cart is empty</h3>
                    ...
                    {isMounted && items.map(({product}) => {
                        ...
                        return(
                            <li key={product.id} className="flex py-6 sm:py-10">
                                ...
                                <div className="ml-4 flex flex-1 flex-col justify-between sm:m1-6">
